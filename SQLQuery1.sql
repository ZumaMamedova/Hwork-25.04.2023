...
INSERT INTO Elan VALUES(1,1,1,2009,'W12345L789',1,18000,4,2,50,2200,1,1,2,110000,56000)
INSERT INTO Elan VALUES(1,1,1,2022,'ZA12345L89',1,52000,5,1,75,3500,3,1,2,155000,72000)
INSERT INTO Elan VALUES(1,1,1,2017,'X12345LA89',1,32000,4,3,40,2800,5,1,2,143000,64500)
INSERT INTO Elan VALUES(1,1,1,2002,'V1RT45L789',1,13000,4,5,32,1800,1,1,2,201568,102000)
INSERT INTO Elan VALUES(1,1,1,1996,'P1245L780K',1,8000,4,2,21,1400,4,1,1,127890,160000)

SELECT * FROM Elan
SELECT * FROM YerlerinSayi
SELECT * FROM Surat

SELECT E.ValutaId, E.BazarId, R.RangName FROM Elan AS E
JOIN Rang AS R
ON E.RangId=R.Id
